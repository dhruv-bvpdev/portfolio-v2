      ...
      <Container>
        ...
        <SimpleGrid columns={[1, 1, 2]} gap={6}>
          <Section>
            ...
            >
              E-Commerce Platform for a range of electronics (with an admin
              panel to add, delete and update products, users and orders)
            </WorkGridItem>
          </Section>
          ...
          <Section delay={0.1}>
            ...
            >
              Local Pizza Joint Website built using Gatsby and Styled
              Components. The data is stored and fetched from Sanity (a headless
              node.js CMS built for structured content)
            </WorkGridItem>
          </Section>
